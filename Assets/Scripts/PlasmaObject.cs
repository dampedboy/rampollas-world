...
public class PlasmaObject : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        if (otherObject.CompareTag("MetalBlock") || otherObject.CompareTag("SteelBlock") || otherObject.CompareTag("WoodBlock") || otherObject.CompareTag("GlassBlock") || otherObject.CompareTag("PlasmaBlock"))
        {
